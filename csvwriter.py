...
if __name__=="__main__":
	...
	# with open(outcsv,'w') as outputfile:
	# 	for f in files:
	# 		file = open(f, 'r')
	...
	# 	string = '';
	# 	for t in fwlen:
	# 		string = string + t[1] +', ' + str(t[0]) + ', ' +  t[2] + ', ' + t[3] + ", source ~/.bashrc; source ~/.bash_profile; cd ../massprfout; massprf -p  " + t[2] + ' -d ' + t[3] + ' -ic 1 -sn 49 -ci_m 1 -r 1 -ci_r 1 -exact 0 -mn 10000 -t 1 -v 0 >> ' + t[1] + '.prfout \n'
